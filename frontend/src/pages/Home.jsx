    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? '36px' : '60px' }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          We are a music collective originating from the heart of{' '}
          <strong style={{ color: 'var(--color-yellow)' }}>The Camp</strong>.{' '}
      ...
      <section style={{
        ...
        <div className="glass-panel" style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              letterSpacing: '1px', color: 'var(--color-ash)', fontWeight: '600',
            }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <p style={{ color: 'var(--color-ash)', fontSize: isMobile ? '0.92rem' : '1rem', lineHeight: '1.7' }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: isMobile ? '0.82rem' : '0.9rem', color: 'var(--color-cream)' }}>

    ...
    <>
      <div style={{
        ...
        {isMobile ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 }}>
            <button onClick={handlePrev} style={{ color: 'var(--color-ash)', padding: '6px' }}>
            ...
            <button onClick={handleNext} style={{ color: 'var(--color-ash)', padding: '6px' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
          ...
          /* Desktop: Full controls + progress bar */
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              <button
                onClick={handlePrev}
                style={{ color: 'var(--color-ash)', transition: 'var(--transition-smooth)' }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', width: '100%' }}>
              ...
              <input
                ...
                onChange={handleSeek}
                style={{
                  flex: 1, accentColor: 'var(--color-pink)', height: '4px',
                  borderRadius: '2px', background: 'rgba(255, 255, 255, 0.1)', cursor: 'pointer',
                }}
              />
        ...
        {/* Right: Volume & Lyrics Toggle — desktop only */}
        {!isMobile && (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <input
                ...
                style={{ width: '70px', accentColor: 'var(--color-orange)', height: '3px', cursor: 'pointer' }}
              />
            </div>
      ...
      {showLyrics && (
        <div style={{
          ...
          height: 'calc(100vh - 110px)', zIndex: 98,
          background: 'rgba(9, 6, 5, 0.95)',
          backdropFilter: 'blur(30px)',
          display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
          animation: 'fadeIn 0.3s ease', padding: '40px 20px',
        }}>
          {/* Close Header */}
          <div style={{
            position: 'absolute', top: '30px', width: '100%', maxWidth: '800px',
            ...
            <button
              ...
              style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                backgroundColor: 'rgba(255,255,255,0.05)', color: 'var(--color-cream)',
              }}
            >
          ...
          {/* Lyrics Content */}
          <div style={{
            maxWidth: '600px', height: '70%', overflowY: 'auto',
            textAlign: 'center', paddingRight: '10px', marginTop: '40px',
            ...
            <pre style={{
              fontFamily: 'var(--font-sans)', fontSize: '1.25rem', lineHeight: '2.2',
              color: 'var(--color-cream)', whiteSpace: 'pre-wrap', padding: '60px 0',
            }}>
              {currentSong.lyrics}
            </pre>
          </div>
